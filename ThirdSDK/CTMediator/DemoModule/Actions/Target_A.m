...
{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"" message:@"这是一张图片" preferredStyle:UIAlertControllerStyleAlert];
...
{
    NSLog(@"");
    NSDictionary *map = @{@"msg":message?:@"", @"name":@"wugl", @"height":@170};
    if (cancelAction) {
        cancelAction(map);
    }
    if (confirmAction) {
